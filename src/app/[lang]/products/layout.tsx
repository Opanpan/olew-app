...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    title: isIndonesian
      ? 'Pilih Solusi Kemasan Anda | Welo Group'
      : 'Choose Your Packaging Solution | Welo Group',
    ...
    openGraph: {
      title: isIndonesian ? 'Produk Kemasan | Welo Group' : 'Packaging Products | Welo Group',
      description: isIndonesian
