...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    title: isIndonesian
      ? 'Botol Premium untuk Setiap Kebutuhan | Welo Group'
      : 'Premium Bottles for Every Need | Welo Group',
    ...
    openGraph: {
      title: isIndonesian ? 'Botol Premium | Welo Group' : 'Premium Bottles | Welo Group',
      description: isIndonesian
